...
This repository is divided in different notebooks that:
  ...
  - 02a. Plot the physical amplification drivers for the current simulation with respect to the preindustrial simulation including cross sections
  - 02b. Plot the physical amplification drivers for the future simulations with respect to the current simulation including cross sections
